...
powershell -NoProfile -Command ^
    ...
    "Write-Host '-------------------------------------------------------------------' -ForegroundColor Gray; " ^
    "if ($kw -ge 22.0) { " ^
    "  Write-Host ' >>> ' -NoNewline -ForegroundColor White; Write-Host 'RESULT: OVERLOAD - EXCEEDS PEAK 22kW' -NoNewline -ForegroundColor Red; Write-Host ' <<<' -ForegroundColor White " ^
    "} elseif ($kw -ge 18.5) { " ^
    "  Write-Host ' >>> ' -NoNewline -ForegroundColor White; Write-Host 'RESULT: WARNING - PEAK ZONE 15min (18.5-22kW)' -NoNewline -ForegroundColor Yellow; Write-Host ' <<<' -ForegroundColor White " ^
    "} else { " ^
    "  Write-Host ' >>> ' -NoNewline -ForegroundColor White; Write-Host 'RESULT: SAFE - WITHIN 18.5kW CONTINUOUS' -NoNewline -ForegroundColor Green; Write-Host ' <<<' -ForegroundColor White " ^
    "}; " ^
    "if ($torque -gt 2124) { Write-Host ' !!! TORQUE WARNING: EXCEEDS SPINDLE RATING (240Nm) !!!' -ForegroundColor Red }; " ^
    "Write-Host '-------------------------------------------------------------------' -ForegroundColor Gray; "
