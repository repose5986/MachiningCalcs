...
start "Nakamura Logic Engine" powershell -NoProfile -ExecutionPolicy Bypass -Command "Invoke-Expression (Get-Content '%~f0' -Raw)"
pause
exit /b
#>
...
$form.Text = 'Nakamura HP Calculator'
...
mkL "Torque:" 350;        $tTrq = mkL "---" 350; $tTrq.Left=230
mkL "MRR:" 380;           $tMrr = mkL "---" 380; $tMrr.Left=230
