...
$form.Text = 'Drilling Speed/Feed Master'
$form.Size = '380,480'
$form.BackColor = $bg
$form.ForeColor = $fg
...
mkL "Feed Rate (IPR)" 300;     $tIpr = mkT 300 "0.005"
